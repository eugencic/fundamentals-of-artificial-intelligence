...
class FamilyRules:
    ...
    education = "(?x) looks for trips that involve educational experiences"
...
class MedicalRules(CommonRules):
    ...
    recovery = "(?x) requires post operative recovery"
...
TOURIST_RULES = (
    ...
    IF(OR(FamilyRules.children, FamilyRules.cultures),
